...
{
    class ZoomInAction<TParent> : PinchAction<TParent> where TParent : IBlock
    {
        public ZoomInAction(TParent parent, Func<TParent, IHasBackingElement> getStartElement)
            : base(parent, getStartElement)
        {
        }

        public ZoomInAction(TParent parent, int centerY, int centerX) : base(parent, centerY, centerX)
        {
        }
